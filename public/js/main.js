...
$(document).ready(function() {
  var jPlayerDiv, playSong, setTitle;
  ...
  playSong = function(songUrl, songTitle, dontStartPlaying) {
    if (dontStartPlaying) {
  ...
  $('.playableSong').click(function(e) {
    var songDiv, songTitle, songUrl;
    e.preventDefault();
    songDiv = $(this);
    songUrl = songDiv.attr('url');
    songTitle = songDiv.attr('title');
    return playSong(songUrl, songTitle);
  });

  playSong('https://s3.amazonaws.com/jvkoh-music/floatintheocean', 'Float in the Ocean', true);
